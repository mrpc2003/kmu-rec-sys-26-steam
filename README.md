...
현재 결론은 대형 LLM/graph 모델을 바로 구현하기보다, **PURL/CW loss류의 implicit-feedback 보정**, **ICPNS류의 community-aware negative sampling/validation**, **TFPS류의 time-decay confidence**를 먼저 탐색하는 것입니다.
